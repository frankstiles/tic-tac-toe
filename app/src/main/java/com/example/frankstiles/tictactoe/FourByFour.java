...
public class FourByFour extends AppCompatActivity {
    ...
    private Button btn_1,btn_2,btn_3,btn_4,btn_5,btn_6,btn_7,btn_8,btn_9,btn_10,
            btn_11,btn_12,btn_13,btn_14,btn_15,btn_16;
        ...
        btn_main.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent I = new Intent(FourByFour.this,MainActivity.class);
                startActivity(I);
            }
        });
    }
    ...
    public void enableSound(int resourceId){
        ...
        if(hasSound){
            releaseResource();
            mediaPlayer = MediaPlayer.create(FourByFour.this, resourceId);
            mediaPlayer.start();
    ...
    public boolean checkPlayerWin( ){
        ...
        if(moves[0][0].getText().toString().equals(getPlayerOneChar())      &&
                ...
                moves[0][3].getText().toString().equals(getPlayerOneChar()))return true;
        if(moves[1][0].getText().toString().equals(getPlayerOneChar())      &&
                ...
                moves[1][3].getText().toString().equals(getPlayerOneChar()))return true;
        if(moves[2][0].getText().toString().equals(getPlayerOneChar())      &&
                ...
                moves[2][3].getText().toString().equals(getPlayerOneChar()))return true;
        if(moves[3][0].getText().toString().equals(getPlayerOneChar())      &&
                ...
                moves[3][3].getText().toString().equals(getPlayerOneChar()))return true;
        if(moves[0][0].getText().toString().equals(getPlayerOneChar())      &&
                moves[1][0].getText().toString().equals(getPlayerOneChar()) &&
                moves[2][0].getText().toString().equals(getPlayerOneChar()) &&
                moves[3][0].getText().toString().equals(getPlayerOneChar()))return true;
        if(moves[0][1].getText().toString().equals(getPlayerOneChar())      &&
                moves[1][1].getText().toString().equals(getPlayerOneChar()) &&
                moves[2][1].getText().toString().equals(getPlayerOneChar()) &&
                moves[3][1].getText().toString().equals(getPlayerOneChar()))return true;
        if(moves[0][2].getText().toString().equals(getPlayerOneChar())      &&
                moves[1][2].getText().toString().equals(getPlayerOneChar()) &&
                moves[2][2].getText().toString().equals(getPlayerOneChar()) &&
                moves[3][2].getText().toString().equals(getPlayerOneChar()))return true;
    ...
    public boolean checkCompWin( ){
        ...
        if(moves[0][0].getText().toString().equals(getCompChar())      &&
                moves[0][1].getText().toString().equals(getCompChar()) &&
                moves[0][2].getText().toString().equals(getCompChar())  &&
                moves[0][3].getText().toString().equals(getCompChar()))return true;
        if(moves[1][0].getText().toString().equals(getCompChar())      &&
                moves[1][1].getText().toString().equals(getCompChar()) &&
                moves[1][2].getText().toString().equals(getCompChar()) &&
                moves[1][3].getText().toString().equals(getCompChar()))return true;
        if(moves[2][0].getText().toString().equals(getCompChar())      &&
                moves[2][1].getText().toString().equals(getCompChar()) &&
                moves[2][2].getText().toString().equals(getCompChar()) &&
                moves[2][3].getText().toString().equals(getCompChar()))return true;
        if(moves[3][0].getText().toString().equals(getCompChar())      &&
                moves[3][1].getText().toString().equals(getCompChar()) &&
                moves[3][2].getText().toString().equals(getCompChar()) &&
                moves[3][3].getText().toString().equals(getCompChar()))return true;
        if(moves[0][0].getText().toString().equals(getCompChar())      &&
                moves[1][0].getText().toString().equals(getCompChar()) &&
                moves[2][0].getText().toString().equals(getCompChar()) &&
                moves[3][0].getText().toString().equals(getCompChar()))return true;
        if(moves[0][1].getText().toString().equals(getCompChar())      &&
                moves[1][1].getText().toString().equals(getCompChar()) &&
                moves[2][1].getText().toString().equals(getCompChar()) &&
                moves[3][1].getText().toString().equals(getCompChar()))return true;
        if(moves[0][2].getText().toString().equals(getCompChar())      &&
                moves[1][2].getText().toString().equals(getCompChar()) &&
                moves[2][2].getText().toString().equals(getCompChar()) &&
                moves[3][2].getText().toString().equals(getCompChar()))return true;
        if(moves[0][3].getText().toString().equals(getCompChar())      &&
                moves[1][3].getText().toString().equals(getCompChar()) &&
                moves[2][3].getText().toString().equals(getCompChar()) &&
                moves[3][3].getText().toString().equals(getCompChar()))return true;
        if(moves[0][3].getText().toString().equals(getCompChar())      &&
                moves[1][2].getText().toString().equals(getCompChar()) &&
                moves[2][1].getText().toString().equals(getCompChar()) &&
    ...
    public boolean checkPlayerWinAndPaint( ){
        ...
        if(moves[1][0].getText().toString().equals(getPlayerOneChar())      &&
                ...
                moves[1][3].setBackgroundColor(color); return true;}
        ...
        if(moves[2][0].getText().toString().equals(getPlayerOneChar())      &&
                ...
                moves[2][3].setBackgroundColor(color); return true;}
        ...
        if(moves[3][0].getText().toString().equals(getPlayerOneChar())      &&
                ...
                moves[3][3].setBackgroundColor(color); return true;}
        ...
        if(moves[0][0].getText().toString().equals(getPlayerOneChar())      &&
                ...
                moves[1][0].setBackgroundColor(color);
                moves[2][0].setBackgroundColor(color);
                moves[3][0].setBackgroundColor(color); return true;}
        ...
        if(moves[0][1].getText().toString().equals(getPlayerOneChar())      &&
                ...
                moves[1][1].setBackgroundColor(color);
                moves[2][1].setBackgroundColor(color);
                moves[3][1].setBackgroundColor(color); return true;}
        ...
        if(moves[0][2].getText().toString().equals(getPlayerOneChar())      &&
                ...
                moves[1][1].setBackgroundColor(color);
                moves[2][2].setBackgroundColor(color);
                moves[3][2].setBackgroundColor(color); return true;}
    ...
    public void displayMsg(String Text){
        Toast.makeText(FourByFour.this, Text, Toast.LENGTH_SHORT).show();
    }
