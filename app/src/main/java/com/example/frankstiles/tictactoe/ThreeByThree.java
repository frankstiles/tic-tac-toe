...
public class ThreeByThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         **/
        setBtnListeners(btn_1);
        setBtnListeners(btn_2);
        setBtnListeners(btn_3);
        setBtnListeners(btn_4);
        setBtnListeners(btn_5);
        setBtnListeners(btn_6);
        setBtnListeners(btn_7);
        setBtnListeners(btn_8);
        setBtnListeners(btn_9);
        ...
        btn_main.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent I = new Intent(ThreeByThree.this,MainActivity.class);
                startActivity(I);
            }
        });
    }
 ...
 * */
    public void setBtnListeners(Button btns){
        ...
        public void enableSound(int resourceId){
            ...
            if(hasSound){
                releaseResource();
                mediaPlayer = MediaPlayer.create(ThreeByThree.this, resourceId);
                mediaPlayer.start();
        ...
        public boolean checkCompWin( ){
            ...
            if(moves[0][0].getText().toString().equals(getCompChar())      &&
                    ...
                    moves[0][2].getText().toString().equals(getCompChar()))return true;
            if(moves[1][0].getText().toString().equals(getCompChar())      &&
                    moves[1][1].getText().toString().equals(getCompChar()) &&
                    moves[1][2].getText().toString().equals(getCompChar()))return true;
            if(moves[2][0].getText().toString().equals(getCompChar())      &&
                    moves[2][1].getText().toString().equals(getCompChar()) &&
                    moves[2][2].getText().toString().equals(getCompChar()))return true;
            if(moves[0][0].getText().toString().equals(getCompChar())      &&
                    moves[1][0].getText().toString().equals(getCompChar()) &&
                    moves[2][0].getText().toString().equals(getCompChar()))return true;
            if(moves[0][1].getText().toString().equals(getCompChar())      &&
                    moves[1][1].getText().toString().equals(getCompChar()) &&
                    moves[2][1].getText().toString().equals(getCompChar()))return true;
        ...
        public void displayMsg(String Text){
            Toast.makeText(ThreeByThree.this, Text, Toast.LENGTH_SHORT).show();
        }
